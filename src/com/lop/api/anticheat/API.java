...
public class API {
	...
	public static String PrefixStaffer = "§c§lCHEAT: §f";
	
	public static void sendStaffer(Player p, String mensagem) {
		for (Player jogadores : Bukkit.getOnlinePlayers()) {
				if (jogadores != p) {
					jogadores.sendMessage(PrefixStaffer + mensagem + WHITE + ".");
				}
			}
		}
	}