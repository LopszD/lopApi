...
public class IncineradorListener implements Listener {

	@EventHandler
	public void onDamage(ProjectileHitEvent e) {
		if (((e.getEntity() instanceof ThrownPotion)) && (e.getEntity().hasMetadata("Incinerador"))) {
	...
	public void onInteract(PlayerInteractEvent e) {
		...
		if ((e.hasItem()) && (e.getItem().hasItemMeta()) && (e.getItem().getItemMeta().hasDisplayName()) && (e.getItem().getItemMeta().getDisplayName().contains("§eIncinerador"))) {
			e.setCancelled(true);
			...
			e.getPlayer().updateInventory();
			((ThrownPotion) e.getPlayer().launchProjectile(ThrownPotion.class)).setMetadata("Incinerador", new FixedMetadataValue(Main.getInstance(), Boolean.valueOf(true)));
