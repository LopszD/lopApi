...
public class ItensCaixas {
	...
	public static ItemStack getItemLendaria() {
		...
		if (item == null) {
			item = new ItemStack(Material.getMaterial(42), 8, (short) 0);
		}
		return item;
	}
	...
	public static List<ItemStack> getLista() {
		...
		ItemStack a = new ItemStack(Material.getMaterial(42), 8, (short) 0);
		lan.put(a, "0@5");
		las.add(a);
		
		a = new ItemStack(Material.getMaterial(41), 8, (short) 0);
		lan.put(a, "6@10");
		las.add(a);
		
		a = new ItemStack(Material.getMaterial(57), 8, (short) 0);
		lan.put(a, "11@15");
		las.add(a);
		
		a = new ItemStack(Material.getMaterial(133), 8, (short) 0);
		lan.put(a, "16@20");
		las.add(a);
		
		a = new ItemStack(Material.getMaterial(49), 16, (short) 0);
		lan.put(a, "21@25");
		las.add(a);
		
		a = new ItemStack(Material.getMaterial(7), 16, (short) 0);
		lan.put(a, "26@30");
		las.add(a);

		a = new ItemStack(Material.FIREWORK, 2);
		...
		a = new ItemStack(Material.getMaterial(383), 1, (short) 50);
		lan.put(a, "37@38");
		las.add(a);

		a = new ItemStack(Material.getMaterial(322), 4, (short) 1);
		lan.put(a, "39@40");
		las.add(a);

		a = new ItemStack(Material.getMaterial(322), 8, (short) 1);
		lan.put(a, "41@42");
		las.add(a);
		...
		a.addUnsafeEnchantment(Enchantment.ARROW_DAMAGE, 3);
		...
		a = new ItemStack(Material.getMaterial(278), 1, (short) 0);
		a.addUnsafeEnchantment(Enchantment.DIG_SPEED, 3);
		a.addUnsafeEnchantment(Enchantment.DURABILITY, 3);
		...
		a.addUnsafeEnchantment(Enchantment.DAMAGE_ALL, 3);
		a.addUnsafeEnchantment(Enchantment.DURABILITY, 2);
		a.addUnsafeEnchantment(Enchantment.FIRE_ASPECT, 1);
		lan.put(a, "48@48");
		las.add(a);
		
		a = new ItemStack(Material.getMaterial(276), 1, (short) 0);
		a.addUnsafeEnchantment(Enchantment.DAMAGE_ALL, 4);
		a.addUnsafeEnchantment(Enchantment.DURABILITY, 3);
		a.addUnsafeEnchantment(Enchantment.FIRE_ASPECT, 1);
		lan.put(a, "49@49");
		las.add(a);
